...
crawl_date: "2025-11-16T07:57:09.604959Z"
selector: ".content"
---
...
| popups\_ignorealpha | works like ignorealpha in layer rules. If pixel opacity is below set value, will not blur. [0.0 - 1.0] | float | 0.2 |
| input\_methods | whether to blur input methods (e.g. fcitx5) | bool | false |
| input\_methods\_ignorealpha | works like ignorealpha in layer rules. If pixel opacity is below set value, will not blur. [0.0 - 1.0] | float | 0.2 |
...
| render\_unfocused\_fps | the maximum limit for renderunfocused windows’ fps in the background (see also [Window-Rules](../Window-Rules/#dynamic-rules) - `renderunfocused`) | int | 15 |
...
| size\_limits\_tiled | whether to apply minsize and maxsize rules to tiled windows | bool | false |
